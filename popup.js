$(function() {
    ...
    var bookController = {
        init: function(bookTreeList) {
            this.bookList = [];
            for (let index = 0; index < bookTreeList.length; index++) {
    ...
    var pageController = {
        ...
        init: function() {
            ...
            this.$btnAutoUpdate = $('#btnAutoUpdate');
        ...
        bindEvent: function() {
            ...
            //自定更新按钮
            this.$btnAutoUpdate.click(this.onOper.bind(this));
            // this.$btnAutoUpdate.click(function() {

            //     //去github得到最新的数据
            //     that.download(opts, function(err, bookmarks) {
        ...
        onOper: function(e) {
            ...
            if (type == 'upload') {
                ...
                //自动更新
                this.download(opts, function(err, githubBookmarks) {
                    //获取到远程的 书签数据
                    console.log(JSON.stringify(githubBookmarks));
                    that.$loading.hide();
                })
